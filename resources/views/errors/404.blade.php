...
<head>
    ...
    <title>404 – Page Not Found | Product Management</title>
    ...
    <style>
        ...
        .error-code { font-size:7rem; font-weight:800; background:linear-gradient(135deg,#6366f1,#8b5cf6); -webkit-background-clip:text; -webkit-text-fill-color:transparent; line-height:1; }
